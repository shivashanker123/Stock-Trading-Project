            ...
            <div className='row p-5'>
                ...
                <div className='col-6 py-5 mt-5'>
                    ...
                    <div className='text-center '>
                        <a href='' className='mx-5' style={{textDecoration:"none" ,fontSize: "0.9rem"}}>Explore our products<i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                        <a href='' style={{textDecoration:"none",fontSize: "0.9rem"}}>Try Kite demo<i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
        </div>
...
//note : fs-1>fs-2>fs-3 these are font sizes //text-muted gives the light font of text
